...
const (
	...
	LONG8     fieldType = 16 // 64-bit unsigned integer
	SLONG8    fieldType = 17 // 64-bit signed integer
	IFD8      fieldType = 18 // 64-bit offset
...
const (
	...
	PredictorFloatingPoint = 3 // For floating point data
)
